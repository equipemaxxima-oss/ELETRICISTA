  ...
  bonuses: [
    {
      ...
      description: "Documento redigido e assinado pelo Diretor indicando você para o Mercado de Trabalho.",
      image: "recommendation"
    },
    {
      title: "Currículo de Alto Impacto",
      description: "Modelo estruturado para chamar a atenção de recrutadores e garantir entrevistas.",
      image: "resume"
    },
    {
  ...
  faq: [
    {
      ...
      answer: "Sim! Ao finalizar o curso você recebe automaticamente seu Certificado de Formação válido em todo o território nacional."
    },
    {
      question: "Preciso ter ensino médio?",
      answer: "Não! O curso é aberto para todos, com ou sem ensino médio completo. Basta ter vontade de aprender."
    },
    {
